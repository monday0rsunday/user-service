...
public class AlnumDencoder {

	private char[] fbases = { 'l', 'm', 'h', 'z', 'd', 'k', '2', '8', '3', '7', 'p', '0', 'c', '9', '6', 't', 'f', '5',
			'j', 'x', 'v', 'a', 'r', 'y', 'n', 'b', 'u', 's', 'g', 'w', 'o', 'i', 'q', '4', '1', 'e' };
	private Map<Character, Integer> rfbases = new HashMap<Character, Integer>();

	private char[] sbases = { '4', 'w', 'n', 'r', 'g', 'p', 't', 'k', 'f', 'i', 'b', '6', 'd', 'j', 'v', 'l', '5', 'o',
			'7', 's', 'a', 'z', 'q', 'u', 'y', '2', 'm', 'c', '9', 'x', '1', '3', '0', 'e', 'h', '8' };
	private HashMap<Character, Integer> rsbases = new HashMap<Character, Integer>();

	private char[] tbases = { 'i', 'j', '5', 'h', '9', 'b', 'n', 'r', 's', 'd', 'v', '4', '3', '1', 'l', 'k', 'g', 'e',
			't', 'q', '0', '8', 'z', '6', 'y', 'p', 'w', 'o', '2', '7', 'm', 'f', 'x', 'a', 'u', 'c' };
	private Map<Character, Integer> rtbases = new HashMap<Character, Integer>();
	private int base = fbases.length;

	public AlnumDencoder() {
	...
	public static void main(String args[]) {
		AlnumDencoder gen = new AlnumDencoder();
